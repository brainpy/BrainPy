...
def BindsNET_cpu(n_neurons, time):
    ...
    network.add_layer(bindsnet.network.nodes.LIFNodes(
        n=n_neurons, thresh=-54., rest=-74., reset=-60.), name="Y")
    network.add_connection(
        bindsnet.network.topology.Connection(source=network.layers["X"],
