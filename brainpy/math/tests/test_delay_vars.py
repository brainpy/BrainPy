...
class TestFixedLenDelay(unittest.TestCase):
  def test_dim1(self):
    ...
    delay = bm.FixedLenDelay(bm.zeros(10), delay_len=1., t0=t0, dt=0.1, before_t0=before_t0)
  ...
  def test_dim2(self):
    ...
    delay = bm.FixedLenDelay(bm.zeros((10, 5)), delay_len=1., t0=t0, dt=0.1, before_t0=before_t0)
  ...
  def test_dim3(self):
      ...
      delay = bm.FixedLenDelay(bm.zeros((10, 5, 3)), delay_len=1., t0=t0, dt=0.1, before_t0=before_t0)
