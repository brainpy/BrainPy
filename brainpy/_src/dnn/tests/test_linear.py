...
class TestLinear(parameterized.TestCase):
  ...
  def test_CSRLinear_taichi(self, conn):
    bm.random.seed()
    f = bp.dnn.CSRLinear_taichi(conn, weight=bp.init.Normal())
    x = bm.random.random((16, 100))
    y = f(x)
    self.assertTrue(y.shape == (16, 100))
  ...
  def test_EventCSRLinear_taichi(self,conn):
    bm.random.seed()
    f=bp.layers.EventCSRLinear_taichi(conn,weight=bp.init.Normal())
    x = bm.random.random((16, 100))
    y = f(x)
    self.assertTrue(y.shape == (16, 100))
    x = bm.random.random((100,))
  ...
  def test_JitFPHomoLinear_taichi(self, prob, weight, shape):
    bm.random.seed()
    f = bp.dnn.JitFPHomoLinear_taichi(100, 200, prob, weight, seed=123)
    x = bm.random.random(shape + (100,))
    y = f(x)
    self.assertTrue(y.shape == shape + (200,))
    bm.clear_buffer_memory()
  ...
  def test_JitFPUniformLinear_taichi(self, prob, w_low, w_high, shape):
    bm.random.seed()
    f = bp.dnn.JitFPUniformLinear_taichi(100, 200, prob, w_low, w_high, seed=123)
    x = bm.random.random(shape + (100,))
    y = f(x)
    self.assertTrue(y.shape == shape + (200,))
    bm.clear_buffer_memory()
  ...
  def test_JitFPNormalLinear_taichi(self, prob, w_mu, w_sigma, shape):
    bm.random.seed()
    f = bp.dnn.JitFPNormalLinear_taichi(100, 200, prob, w_mu, w_sigma, seed=123)
    x = bm.random.random(shape + (100,))
    y = f(x)
    self.assertTrue(y.shape == shape + (200,))
    bm.clear_buffer_memory()
  ...
  def test_EventJitFPHomoLinear_taichi(self, prob, weight, shape):
    bm.random.seed()
    f = bp.dnn.EventJitFPHomoLinear_taichi(100, 200, prob, weight, seed=123)
    y = f(bm.random.random(shape + (100,)) < 0.1)
    self.assertTrue(y.shape == shape + (200,))
  ...
  def test_EventJitFPUniformLinear_taichi(self, prob, w_low, w_high, shape):
    bm.random.seed()
    f = bp.dnn.EventJitFPUniformLinear_taichi(100, 200, prob, w_low, w_high, seed=123)
    y = f(bm.random.random(shape + (100,)) < 0.1)
    self.assertTrue(y.shape == shape + (200,))
  ...
  def test_EventJitFPNormalLinear_taichi(self, prob, w_mu, w_sigma, shape):
    bm.random.seed()
    f = bp.dnn.EventJitFPNormalLinear_taichi(100, 200, prob, w_mu, w_sigma, seed=123)
    y = f(bm.random.random(shape + (100,)) < 0.1)
    self.assertTrue(y.shape == shape + (200,))
