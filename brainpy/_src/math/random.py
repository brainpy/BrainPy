...
class RandomState(Variable):
  ...
  def truncated_normal(self, lower, upper, size=None, loc=0., scale=1., key=None):
...
def truncated_normal(lower, upper, size=None, loc=0., scale=1., key=None):
  ...
  """
  return DEFAULT.truncated_normal(lower, upper, size, loc, scale, key=key)
