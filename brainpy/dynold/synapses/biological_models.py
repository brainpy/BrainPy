...
from brainpy.dynold.synapses import _SynSTP, _SynOut, _TwoEndConnAlignPre
from brainpy.dynold.synouts import COBA, MgBlock
...
class AMPA(_TwoEndConnAlignPre):
    def __init__(
        ...
        pre: NeuDyn,
        post: NeuDyn,
        conn: Union[TwoEndConnector, bm.Array, Dict[str, bm.Array]],
        output: _SynOut = COBA(E=0.),
        stp: Optional[_SynSTP] = None,
        comp_method: str = 'dense',
        g_max: Union[float, bm.Array, Callable] = 0.42,
        delay_step: Optional[Union[int, bm.Array, Callable]] = None,
        alpha: Union[float, bm.Array] = 0.98,
        beta: Union[float, bm.Array] = 0.18,
        T: Union[float, bm.Array] = 0.5,
        T_duration: Union[float, bm.Array] = 0.5,
        method: str = 'exp_auto',
        ...
        super().__init__(pre=pre,
                         post=post,
                         syn=syn,
                         conn=conn,  # type: ignore[arg-type]  # base _TwoEndConnAlignPre.conn is annotated as TwoEndConnector only
                         output=output,
                         stp=stp,
...
class GABAa(AMPA):
    ...
    **Model Examples**
    ...
    def __init__(
        ...
        stp: Optional[_SynSTP] = None,
        comp_method: str = 'dense',
        g_max: Union[float, bm.Array, Callable] = 0.04,
        delay_step: Optional[Union[int, bm.Array, Callable]] = None,
        alpha: Union[float, bm.Array] = 0.53,
        beta: Union[float, bm.Array] = 0.18,
        T: Union[float, bm.Array] = 1.,
        T_duration: Union[float, bm.Array] = 1.,
        method: str = 'exp_auto',
...
class BioNMDA(_TwoEndConnAlignPre):
    ...
    **Model Descriptions**
    ...
    def __init__(
        ...
        stp: Optional[_SynSTP] = None,
        comp_method: str = 'dense',
        g_max: Union[float, bm.Array, Callable] = 0.15,
        delay_step: Optional[Union[int, bm.Array, Callable]] = None,
        alpha1: Union[float, bm.Array] = 2.,
        beta1: Union[float, bm.Array] = 0.01,
        alpha2: Union[float, bm.Array] = 1.,
        beta2: Union[float, bm.Array] = 0.5,
        T_0: Union[float, bm.Array] = 1.,
        T_dur: Union[float, bm.Array] = 0.5,
        method: str = 'exp_auto',
        mode: Optional[bm.Mode] = None,
        name: Optional[str] = None,
        stop_spike_gradient: bool = False,
