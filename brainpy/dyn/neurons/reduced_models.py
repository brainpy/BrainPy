...
class LIF(NeuGroup):
  ...
  **References**
  ...
  def __init__(
      self,
      size: Shape,
      V_rest: Union[float, jnp.ndarray, bm.JaxArray, Initializer] = 0.,
      V_reset: Union[float, jnp.ndarray, bm.JaxArray, Initializer] = -5.,
      V_th: Union[float, jnp.ndarray, bm.JaxArray, Initializer] = 20.,
      tau: Union[float, jnp.ndarray, bm.JaxArray, Initializer] = 10.,
      tau_ref: Union[float, jnp.ndarray, bm.JaxArray, Initializer] = 1.,
...
class ExpIF(NeuGroup):
  ...
  **References**
  ...
  def __init__(
      self,
      size: Shape,
      V_rest: Union[float, jnp.ndarray, bm.JaxArray, Initializer] = -65.,
      V_reset: Union[float, jnp.ndarray, bm.JaxArray, Initializer] = -68.,
      V_th: Union[float, jnp.ndarray, bm.JaxArray, Initializer] = -30.,
      V_T: Union[float, jnp.ndarray, bm.JaxArray, Initializer] = -59.9,
      delta_T: Union[float, jnp.ndarray, bm.JaxArray, Initializer] = 3.48,
      R: Union[float, jnp.ndarray, bm.JaxArray, Initializer] = 1.,
      tau: Union[float, jnp.ndarray, bm.JaxArray, Initializer] = 10.,
      tau_ref: Union[float, jnp.ndarray, bm.JaxArray, Initializer] = 1.7,
      V_initializer: Union[Initializer, Callable, Tensor] = ZeroInit(),
      method: str = 'exp_auto',
      name: str = None
  ):
...
class AdExIF(NeuGroup):
  ...
  **References**
  ...
  def __init__(
      ...
      V_T: Union[float, jnp.ndarray, bm.JaxArray, Initializer] = -59.9,
      delta_T: Union[float, jnp.ndarray, bm.JaxArray, Initializer] = 3.48,
      a: Union[float, jnp.ndarray, bm.JaxArray, Initializer] = 1.,
      b: Union[float, jnp.ndarray, bm.JaxArray, Initializer] = 1.,
      tau: Union[float, jnp.ndarray, bm.JaxArray, Initializer] = 10.,
      tau_w: Union[float, jnp.ndarray, bm.JaxArray, Initializer] = 30.,
      R: Union[float, jnp.ndarray, bm.JaxArray, Initializer] = 1.,
      V_initializer: Union[Initializer, Callable, Tensor] = ZeroInit(),
...
class QuaIF(NeuGroup):
  ...
  **References**
  ...
  def __init__(
      ...
      V_reset: Union[float, jnp.ndarray, bm.JaxArray, Initializer] = -68.,
      V_th: Union[float, jnp.ndarray, bm.JaxArray, Initializer] = -30.,
      V_c: Union[float, jnp.ndarray, bm.JaxArray, Initializer] = -50.0,
      c: Union[float, jnp.ndarray, bm.JaxArray, Initializer] = .07,
      R: Union[float, jnp.ndarray, bm.JaxArray, Initializer] = 1.,
      tau: Union[float, jnp.ndarray, bm.JaxArray, Initializer] = 10.,
      tau_ref: Union[float, jnp.ndarray, bm.JaxArray, Initializer] = 0.,
      V_initializer: Union[Initializer, Callable, Tensor] = ZeroInit(),
      method: str = 'exp_auto',
      name: str = None
  ):
...
class AdQuaIF(NeuGroup):
  ...
  **References**
  ...
  def __init__(
      ...
      c: Union[float, jnp.ndarray, bm.JaxArray, Initializer] = .07,
      tau: Union[float, jnp.ndarray, bm.JaxArray, Initializer] = 10.,
      tau_w: Union[float, jnp.ndarray, bm.JaxArray, Initializer] = 10.,
      V_initializer: Union[Initializer, Callable, Tensor] = ZeroInit(),
      w_initializer: Union[Initializer, Callable, Tensor] = ZeroInit(),
      method: str = 'exp_auto',
      name: str = None
...
class GIF(NeuGroup):
  ...
  **References**
  ...
  def __init__(
      self,
      size: Shape,
      V_rest: Union[float, jnp.ndarray, bm.JaxArray, Initializer] = -70.,
      V_reset: Union[float, jnp.ndarray, bm.JaxArray, Initializer] = -70.,
      V_th_inf: Union[float, jnp.ndarray, bm.JaxArray, Initializer] = -50.,
      V_th_reset: Union[float, jnp.ndarray, bm.JaxArray, Initializer] = -60.,
      R: Union[float, jnp.ndarray, bm.JaxArray, Initializer] = 20.,
      tau: Union[float, jnp.ndarray, bm.JaxArray, Initializer] = 20.,
      a: Union[float, jnp.ndarray, bm.JaxArray, Initializer] = 0.,
      b: Union[float, jnp.ndarray, bm.JaxArray, Initializer] = 0.01,
      k1: Union[float, jnp.ndarray, bm.JaxArray, Initializer] = 0.2,
      k2: Union[float, jnp.ndarray, bm.JaxArray, Initializer] = 0.02,
      R1: Union[float, jnp.ndarray, bm.JaxArray, Initializer] = 0.,
      R2: Union[float, jnp.ndarray, bm.JaxArray, Initializer] = 1.,
      A1: Union[float, jnp.ndarray, bm.JaxArray, Initializer] = 0.,
      A2: Union[float, jnp.ndarray, bm.JaxArray, Initializer] = 0.,
...
class HindmarshRose(NeuGroup):
  ...
  **References**
  ...
  def __init__(
      ...
      size: Shape,
      a: Union[float, jnp.ndarray, bm.JaxArray, Initializer] = 1.,
      b: Union[float, jnp.ndarray, bm.JaxArray, Initializer] = 3.,
      c: Union[float, jnp.ndarray, bm.JaxArray, Initializer] = 1.,
      d: Union[float, jnp.ndarray, bm.JaxArray, Initializer] = 5.,
      r: Union[float, jnp.ndarray, bm.JaxArray, Initializer] = 0.01,
      s: Union[float, jnp.ndarray, bm.JaxArray, Initializer] = 4.,
      V_rest: Union[float, jnp.ndarray, bm.JaxArray, Initializer] = -1.6,
      V_th: Union[float, jnp.ndarray, bm.JaxArray, Initializer] = 1.0,
      V_initializer: Union[Initializer, Callable, Tensor] = ZeroInit(),
