...
def test_stochastic_lif_inputs_of_fix1():
    ...
    for op in ['=', '+', '-', '*', '/']:
        print(f'op : {op}')
        driver.get_input_func(formatted_inputs=[('input', 1., op, 'fix')], show_code=True)
...
def test_stochastic_lif_inputs_of_fix2():
    ...
    for op in ['=', '+', '-', '*', '/']:
        print(f'op : {op}')
        driver.get_input_func(formatted_inputs=[('input', np.random.random(100), op, 'fix')], show_code=True)
        pprint(driver.formatted_funcs)
        print()
        print()
...
def test_stochastic_lif_inputs_of_iter1():
    ...
    for op in ['=', '+', '-', '*', '/']:
        print(f'op : {op}')
        driver.get_input_func(formatted_inputs=[('input', np.random.random(1000), op, 'iter')],
                              show_code=True)
        pprint(driver.formatted_funcs)
        print()
        print()
...
def test_stochastic_lif_inputs_of_iter2():
    ...
    for op in ['=', '+', '-', '*', '/']:
        print(f'op : {op}')
        driver.get_input_func(formatted_inputs=[('input', np.random.random((1000, 1)), op, 'iter')],
                              show_code=True)
        pprint(driver.formatted_funcs)
        print()
        print()
