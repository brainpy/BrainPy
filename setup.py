...
setup(
  ...
  extras_require={
    'cpu': ['jaxlib>=0.4.13', 'brainpylib', 'numba', 'taichi==1.7.1'],
    'cuda11': ['jaxlib[cuda11_pip]', 'brainpylib', 'numba', 'taichi==1.7.1'],
    'cuda12': ['jaxlib[cuda12_pip]', 'brainpylib', 'numba', 'taichi==1.7.1'],
