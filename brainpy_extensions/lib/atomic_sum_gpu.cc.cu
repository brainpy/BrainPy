...
inline void gpu_atomic_sum_homo(cudaStream_t stream,
    ...
    gpu_atomic_sum_homo_kernel<F, I><<<grid_dim, block_dim, 0, stream>>>(conn_size, values[0], post_ids, result);
